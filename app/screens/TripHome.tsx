  ...
  const trips = [
    {
      ...
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSm8ErlMlPdnS5zbhJ2KL339H-cCsjrxjMl8A&usqp=CAU",
    },
    {
      destination: "Miami",
      uid: "uid2",
      attendees: [],
      duration: { start: new Date(), end: new Date() },
      image: "https://c4.wallpaperflare.com/wallpaper/28/440/22/skyline-cityscape-miami-florida-wallpaper-preview.jpg",
    },
    {
